...
#
# -------------------------------------------------------------------
class FRACTIONADDITIONXBLOCKCLASS(XBlock):
    """
    ...
    brd = String(help="The behavior graph.",
                 default="public/problem_files/FractionAddition.brd",
                 scope=Scope.settings)
    ...
    def workbench_scenarios():
        return [
            ("FRACTIONADDITIONXBLOCKCLASS",
             """<vertical_demo>
                <fractionadditionxblock width="" height=""/>
                </vertical_demo>
             """),
        ]
